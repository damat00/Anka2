...
// ========================================================================
// $File: //jeffr/granny_29/rt/granny_spu_animation_binding.h $
...
EXPAPI GS_MODIFY spu_animation_binding *AcquireSPUAnimationBindingFromID(spu_animation_binding_id &ID);

EXPAPI GS_MODIFY spu_animation_binding *AcquireSPUAnimationBinding(spu_animation_binding *Binding);
