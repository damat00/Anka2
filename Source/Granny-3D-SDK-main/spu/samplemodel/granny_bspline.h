...
// ========================================================================
// $File: //jeffr/granny_29/rt/granny_bspline.h $
...
void SampleBSpline0x1(real32 const *ti, real32 const *pi,
                      real32 t, real32 *Result);
void SampleBSpline0x2(real32 const *ti, real32 const *pi,
                      real32 t, real32 *Result);
void SampleBSpline0x3(real32 const *ti, real32 const *pi,
                      real32 t, real32 *Result);
void SampleBSpline0x4(real32 const *ti, real32 const *pi,
                      real32 t, real32 *Result);
void SampleBSpline0x9(real32 const *ti, real32 const *pi,
                      real32 t, real32 *Result);
void SampleBSpline0xN(real32 const *ti, real32 const *pi,
                      int32 Dimension, bool Normalize,
                      real32 t, real32 *Result);

void SampleBSpline1x1(real32 const *ti, real32 const *pi,
                      real32 t, real32 *Result);
void SampleBSpline1x2(real32 const *ti, real32 const *pi,
                      real32 t, real32 *Result);
void SampleBSpline1x3(real32 const *ti, real32 const *pi,
                      real32 t, real32 *Result);
void SampleBSpline1x3n(real32 const *ti, real32 const *pi,
                       real32 t, real32 *Result);
void SampleBSpline1x4(real32 const *ti, real32 const *pi,
                      real32 t, real32 *Result);
void SampleBSpline1x4n(real32 const *ti, real32 const *pi,
                       real32 t, real32 *Result);
void SampleBSpline1x9(real32 const *ti, real32 const *pi,
                      real32 t, real32 *Result);
void SampleBSpline1xN(real32 const *ti, real32 const *pi,
                      int32 Dimension, bool Normalize,
                      real32 t, real32 *Result);

void SampleBSpline2x1(real32 const *ti, real32 const *pi,
                      real32 t, real32 *Result);
void SampleBSpline2x2(real32 const *ti, real32 const *pi,
                      real32 t, real32 *Result);
void SampleBSpline2x3(real32 const *ti, real32 const *pi,
                      real32 t, real32 *Result);
void SampleBSpline2x3n(real32 const *ti, real32 const *pi,
                       real32 t, real32 *Result);
void SampleBSpline2x4(real32 const *ti, real32 const *pi,
                      real32 t, real32 *Result);
void SampleBSpline2x4n(real32 const *ti, real32 const *pi,
                       real32 t, real32 *Result);
void SampleBSpline2x9(real32 const *ti, real32 const *pi,
                      real32 t, real32 *Result);
void SampleBSpline2xN(real32 const *ti, real32 const *pi,
                      int32 Dimension, bool Normalize,
                      real32 t, real32 *Result);

void SampleBSpline3x1(real32 const *ti, real32 const *pi,
                      real32 t, real32 *Result);
void SampleBSpline3x2(real32 const *ti, real32 const *pi,
                      real32 t, real32 *Result);
void SampleBSpline3x3(real32 const *ti, real32 const *pi,
                      real32 t, real32 *Result);
void SampleBSpline3x3n(real32 const *ti, real32 const *pi,
                       real32 t, real32 *Result);
void SampleBSpline3x4(real32 const *ti, real32 const *pi,
                      real32 t, real32 *Result);
void SampleBSpline3x4n(real32 const *ti, real32 const *pi,
                       real32 t, real32 *Result);
void SampleBSpline3x9(real32 const *ti, real32 const *pi,
                      real32 t, real32 *Result);
void SampleBSpline3xN(real32 const *ti, real32 const *pi,
                      int32 Dimension, bool Normalize,
                      real32 t, real32 *Result);
