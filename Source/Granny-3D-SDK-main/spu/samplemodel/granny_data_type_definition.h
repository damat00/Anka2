...
// ========================================================================
// $File: //jeffr/granny_29/rt/granny_data_type_definition.h $
...
EXPTYPE enum marshalling_type
{
    ...
    marshalling_type_forceint = 0x7fffffff
};

// It shouldn't need to be said, but NONE OF THESE VALUES MAY CHANGE.  Ever.  For realz.
EXPTYPE enum member_type
{
    ...
    UnsupportedMemberType_Remove,  // No, actually, don't remove it.
    ...
    member_type_forceint = 0x7fffffff
};
...
EXPAPI GS_SAFE uintaddrx MakeEmptyDataTypeMember(data_type_definition const &MemberType, void *Member);
EXPAPI GS_SAFE uintaddrx MakeEmptyDataTypeObject(data_type_definition const *TypeDefinition, void *Object);
...
EXPCONST EXPGROUP(matrix_4x4) extern data_type_definition Matrix4x4Type[];
EXPCONST EXPGROUP(variant) extern data_type_definition VariantType[];
