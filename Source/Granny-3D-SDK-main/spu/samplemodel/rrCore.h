/// ========================================================================
// (C) Copyright 1994- 2012 RAD Game Tools, Inc.  Global types header file
// ========================================================================

#ifndef __RADRR_COREH__
#define __RADRR_COREH__
#define RADCOPYRIGHT "Copyright (C) 1994-2012, RAD Game Tools, Inc."
...
//  __RADSEKRIT__ means Sekrit console
//  __RADSEKRIT2__ means yet another Sekrit console
...
#define RADINLINE inline
      ...
      #define __RADPOSIX__
         ...
         !defined(__RADXENON__) && !defined(__RADSEKRIT__) && !defined(__RADSEKRIT2__) && !defined(__RADLINUX__) && !defined(__RADPS2__) &&  \
         ...
         !defined(__RADWIIU__) && !defined(__RADANDROID__) && !defined(__RADNACL__))
      ...
      #define RADEXPFUNC RADDEFFUNC
           ...
           defined(__RADARM__) || defined(__RADWIIU__) || defined(__RADSEKRIT2__) )
      ...
      #define RADASMLINK
          ...
          #elif defined(__RADXENON__) || defined(__RADSEKRIT__) || defined(__RADSEKRIT2__)
   ...
   // probably s.b: RAD_DECLARE_ALIGNED(type, name, alignment)
         ...
         defined(__RADPS3__) || defined(__RADSPU__) || defined(__RADSEKRIT2__) || \
    ...
    #elif (defined(_MSC_VER) && (_MSC_VER >= 1300)) || defined(__RADSEKRIT__)
    ...
    #define RAD_F32 float
      ...
      #define RAD_F64_OR_32  double   // type is F64 if available, otherwise F32
         ...
         defined(__RADNDS__) || defined(__RADPSP__) || defined(__RADPS3__) || defined(__RADSEKRIT2__) || \
         defined(__RADSPU__) || defined(__RADIPHONE__) || defined(__RADNACL__))
    ...
    */
    ...
    #elif defined(__GCC__) || defined(ANDROID)
        #ifdef _DEBUG
...
#elif defined(__RADCELL__) || defined(__RADWII__) || defined(__RADMACAPI__) || defined(__RADWIIU__) || defined(__RADSEKRIT2__)
