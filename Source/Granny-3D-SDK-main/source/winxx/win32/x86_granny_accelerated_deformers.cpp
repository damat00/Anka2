// ========================================================================
// $File: //jeffr/granny_29/rt/x86/x86_granny_accelerated_deformers.cpp $
                ...
                pnt332_vertex *Dest, const float *Trans)
{
    ...
    __asm
    {
        ...
        movaps xmm4, [ecx+00]  // 03|02|01|00
        movaps xmm5, [ecx+16]  // 13|12|11|10
        movaps xmm6, [ecx+32]  // 23|22|21|20
        movaps xmm1, [ecx+48]  // 33|32|31|30
...
transform_loop :
        ...
        movntps [edi], xmm0     // Nx1, Pz1, Py1, Px1
        movntps [edi+16], xmm1  // Tv,  Tu,  Nz1, Ny1
        movntps [edi+32], xmm7  // Nx2, Pz2, Py2, Px2
        movntps [edi+48], xmm2  // Tv,  Tu,  Nz2, Ny2

        add ecx, (2*ASMSIZE(pnt332_vertex));
        add edi, (2*ASMSIZE(pnt332_vertex))
