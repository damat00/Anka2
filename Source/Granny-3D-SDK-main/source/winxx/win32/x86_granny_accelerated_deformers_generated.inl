...
#ifndef X86_GRANNY_ASM_HELPERS_H
...
#error BONE_COUNT is out-of-range
        ...
        __asm
        {
            ...
            // Dest->Position
            movlps STRUCTACCESS(edi, DEST_VERTEX_TYPE, Position), xmm0          // X, Y
            movhlps xmm0, xmm0
            movss STRUCTACCESSOFFSET(edi, 8, DEST_VERTEX_TYPE, Position), xmm0  // Z

            // Dest->Normal
            movlps STRUCTACCESS(edi, DEST_VERTEX_TYPE, Normal), xmm1            // X, Y
            movhlps xmm1, xmm1
            movss STRUCTACCESSOFFSET(edi, 8, DEST_VERTEX_TYPE, Normal), xmm1    // Z
        }
#endif
        ...
        __asm
        {
            ...
            // Dest->Tangent
            movlps STRUCTACCESS(edi, DEST_VERTEX_TYPE, Tangent), xmm0        // X, Y
            movhlps xmm0, xmm0
            movss STRUCTACCESSOFFSET(edi, 8, DEST_VERTEX_TYPE, Tangent), xmm0       // Z

            // Dest->Binormal
            movlps STRUCTACCESS(edi, DEST_VERTEX_TYPE, Binormal), xmm1          // X, Y
            movhlps xmm1, xmm1
            movss STRUCTACCESSOFFSET(edi, 8, DEST_VERTEX_TYPE, Binormal), xmm1         // Z
        }
#else
        __asm
        {
