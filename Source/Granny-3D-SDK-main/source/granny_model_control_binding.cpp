// ========================================================================
// $File: //jeffr/granny_29/rt/granny_model_control_binding.cpp $
                          ...
                          bool Active, void *InitData)
{
    ...
    if(Binding)
    {
        ...
        {
            if (Callbacks.InitializeBindingState(*Binding, InitData) == false)
            {
                Log0(ErrorLogMessage, ControlLogMessage,
                     "CreateModelControlBinding: unable to initialize binding");
