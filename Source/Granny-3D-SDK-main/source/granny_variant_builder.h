...
// ========================================================================
// $File: //jeffr/granny_29/rt/granny_variant_builder.h $
...
EXPAPI GS_PARAM void* EndVariant(variant_builder *Builder,
...
EXPAPI GS_PARAM void AddBoolMember(variant_builder &Builder, char const *Name,
                                   bool32 Value);
EXPAPI GS_PARAM void AddBoolArrayMember(variant_builder &Builder, char const *Name,
                                        int32x Width, bool32* Value);
