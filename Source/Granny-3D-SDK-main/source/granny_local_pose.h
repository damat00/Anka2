...
// ========================================================================
// $File: //jeffr/granny_29/rt/granny_local_pose.h $
...
struct local_pose
{
    ...
    // Used in certain cases where we need to maintain a list of local poses
    local_pose* NextPose;
};
...
EXPAPI GS_PARAM void LinearBlend(local_pose&       Into,
                                 local_pose const& From,
                                 local_pose const& To,
                                 real32            Amount);
EXPAPI GS_PARAM void LinearBlendNeighborhood(local_pose&       Into,
                                             local_pose const& From,
                                             local_pose const& To,
                                             real32            Amount,
                                             skeleton&         NeighborhoodSkeleton);

EXPAPI GS_PARAM void LinearBlendRanged(local_pose&       Into,
                                       local_pose const& From,
                                       local_pose const& To,
                                       int32x            BoneStart,
                                       int32x            BoneCount,
...
EXPAPI GS_PARAM void AdditiveBlend(local_pose* Into,
                                   local_pose const* Additive,
                                   local_pose const* Base,
                                   int32x BoneStart,
                                   int32x BoneCount,
                                   real32 Amount);
EXPAPI GS_PARAM void MaskedAdditiveBlend(local_pose*       Into,
                                         local_pose const* Additive,
                                         local_pose const* Base,
                                         int32x            BoneStart,
                                         int32x            BoneCount,
...
EXPAPI GS_PARAM void EndLocalPoseAccumulationLOD(local_pose &LocalPose,
                                                 int32x FirstBone, int32x BoneCount,
                                                 int32x FirstValidBone,
                                                 int32x ValidBoneCount,
                                                 skeleton const &ReferenceSkeleton,
                                                 real32 AllowedError,
                                                 int32x const *SparseBoneArray);
...
EXPAPI GS_PARAM void CopyLocalPoseBoneCount(local_pose const &Src, local_pose &Dst, int32x BoneStart, int32x BoneCount);
