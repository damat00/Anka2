// ========================================================================
// $File: //jeffr/granny_29/rt/granny_oodle0_compression.cpp $
                 ...
                 void *DecompressedBytes)
{
    ...
    int32x TempSize = LZ_decompress_alloc_size(255, 256, GRANNY_OFFSET);
    void *Temp = AllocateSize(TempSize, AllocationTemporary);
    if (Temp == 0)
    {
        Log1(ErrorLogMessage, CompressorLogMessage, "Oodle0Decompress unable to alloc %d bytes", TempSize);
        return false;
    }
                 ...
                 void *DecompressedBytes)
{
    ...
    int32x const TempSize = LZ_decompress_alloc_size(255, 256, GRANNY_OFFSET);
    void *Temp = AllocateSize(TempSize, AllocationTemporary);
    if (Temp == 0)
    {
        Log1(ErrorLogMessage, CompressorLogMessage, "Oodle0Decompress unable to alloc %d bytes", TempSize);
