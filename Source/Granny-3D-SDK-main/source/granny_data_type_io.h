...
// ========================================================================
// $File: //jeffr/granny_29/rt/granny_data_type_io.h $
...
EXPTYPE enum file_data_tree_flags
{
    ...
    data_tree_flags_forceint = 0x7fffffff
};
...
EXPAPI typedef CALLBACK_FN(uint32) file_writer_string_callback(void *Data, char const *String);
