...
// ========================================================================
// $File: //jeffr/granny_29/rt/granny_camera.h $
// $DateTime: 2012/04/30 13:00:45 $
// $Change: 37171 $
// $Revision: #2 $
//
...
EXPTYPE enum camera_output_z_range
{
    ...
    camera_output_z_range_forceint = 0x7fffffff
};
...
EXPTYPE_EPHEMERAL struct camera
{
    ...
    // Location parameters
    bool32 UseQuaternionOrientation;
    quad Orientation;
    ...
    bool32 MirrorXInView;
    bool32 MirrorYInView;
    bool32 MirrorZInView;
};
...
EXPAPI GS_SAFE void SetCameraFOVX(camera& Camera, real32 FOVX);
...
EXPAPI GS_PARAM void EnsureCameraSeesPoint(camera &Camera, real32 const *Point);
...
#define VerticalIphoneAspectRatio 0.667f EXPMACRO
