...
// ========================================================================
// $File: //jeffr/granny_29/rt/granny_stack_allocator.h $
...
EXPAPI GS_PARAM bool StackInitialize(stack_allocator &Allocator,
                                     int32x UnitSize, int32x UnitsPerBlock);
EXPAPI GS_PARAM bool StackInitializeWithDirectory(stack_allocator &Allocator,
                                                  int32x UnitSize,
                                                  int32x UnitsPerBlock,
                                                  int32x MaxUnits);
...
EXPAPI GS_PARAM void* NewStackUnit(stack_allocator &Allocator, int32x* ResultIndex);
...
#define NEW_STACK_UNIT_AS(Allocator, Type) ((Type*)NewStackUnit(Allocator, 0))
