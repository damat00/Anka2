...
RADDEFSTART
    ...
    #define radloadu32ptr(p) (U32) __lwbrx((void*)(p), 0)
      ...
      {
          return (__rlwimi(__rlwinm( x, 24, 0, 23 ),
                           x, 8, 8, 15) |
                  __rlwinm(x, 8, 24, 31));
      }
      ...
      #define radloadu32ptr(p) (U32) __lwbrx((void*)(p))
    ...
    static inline U32 radloadu32(register U32 x) __attribute__((always_inline));
    static inline U32 radloadu32(register U32 x)
    {
      vec_uint4 v = spu_promote( x, 0 );
    ...
    static inline U32 radloadu32ptr(register void const * src) __attribute__((always_inline));
    static inline U32 radloadu32ptr(register void const * src)
    {
      U32 i = (*((U32*)src));
  ...
  #elif defined( __RADPSP2__ ) || defined(__RADIPHONE__) || defined(__RADWIIU__) || defined(__RADANDROID__) || defined(__RADNACL__)
      #include <stdlib.h>
      ...
      #ifdef __RADWIIU__
        #define radloadu32ptr(p) *((__bytereversed U32*)(p))
      #else
        #define radloadu32ptr(p) *((U32*)(p))   
      #endif
