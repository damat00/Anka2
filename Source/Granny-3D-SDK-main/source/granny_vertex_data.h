...
// ========================================================================
// $File: //jeffr/granny_29/rt/granny_vertex_data.h $
...
// Maximum number of weights that can affect a vertex
...
// Converter for the default granny vertex-specific type conversions (i.e, DEC3N ->
// float[3] normals, etc.)
CALLBACK_FN(bool) VertexMemberConverter(data_type_definition const* SourceMemberType,
...
EXPCONST EXPGROUP(pwt322_vertex) extern data_type_definition PWT322VertexType[];
