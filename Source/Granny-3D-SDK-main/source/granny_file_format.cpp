// ========================================================================
// $File: //jeffr/granny_29/rt/granny_file_format.cpp $
...
{
    CheckInt32Index(SectionIndex, StandardSectionCount,
...
{
    CheckPointerNotNull(TotalHeaderSize,        return false);
    CheckPointerNotNull(IsByteReversed,         return false);
    CheckPointerNotNull(IsPointerSizeDifferent, return false);
