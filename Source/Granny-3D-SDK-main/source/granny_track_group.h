...
// ========================================================================
// $File: //jeffr/granny_29/rt/granny_track_group.h $
// $DateTime: 2012/10/22 16:12:06 $
// $Change: 39901 $
// $Revision: #3 $
//
...
EXPTYPE enum transform_track_flags
{
    ...
    transform_track_flags_forceint = 0x7fffffff
};
...
EXPTYPE enum vector_diff_mode
{
    ...
    vector_diff_mode_forceint = 0x7fffffff
};
...
EXPAPI GS_READ bool KnotsAreReducible(int32x Dimension,
                                      int32x KnotCount,
                                      real32 const *Knots,
...
EXPAPI GS_READ bool FindVectorTrack(track_group const *TrackGroup,
                                    char const *TrackName,
                                    uint32 TrackKey,
                                    int32x &VectorTrackIndex);

EXPAPI GS_READ bool FindTextTrackByName(track_group const *TrackGroup,
                                        char const *TrackName,
