...
// ========================================================================
// $File: //jeffr/granny_29/rt/granny_mesh_deformer.h $
...
EXPTYPE enum deformer_tail_flags
{
    ...
    deformer_tail_flags_forceint = 0x7fffffff
};
...
EXPAPI GS_READ  bool IsDeformerAccelerated(mesh_deformer const& Deformer);
