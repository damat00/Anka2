...
// ========================================================================
// $File: //jeffr/granny_29/rt/granny_file_format.h $
...
EXPTYPE enum standard_section_index
{
    ...
    standard_section_index_forceint = 0x7fffffff
};
...
EXPTYPE struct grn_file_header
{
    ...
    // NOTE!  If you add more variables to the end here, you must adjust the header
    // allocation.  See the functions AdjustedHeaderRead and AdjustHeaderAllocation in
    // granny_file.cpp.
};
