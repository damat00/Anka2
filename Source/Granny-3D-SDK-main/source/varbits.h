...
#define VarBitsLocalGetWithCheckBE(v,typ,vb,len,endp,dowhat)    \
{                                                               \
  if ((vb##bitlen)<len) {                                       \
    register BITSTYPE nb;                                       \
    if ( ( (U8*)(vb##cur) ) >= ( (U8*) (endp) ) ) dowhat        \
...
#define VarBitsLocalGetWithCheckLE(v,typ,vb,len,endp,dowhat)    \
{                                                               \
  if ((vb##bitlen)<len) {                                       \
    register BITSTYPE nb;                                       \
    if ( ( (U8*)(vb##cur) ) >= ( (U8*) (endp) ) ) dowhat        \
...
#define VarBitsLocalGet1WithCheckBE(v,vb,endp,dowhat)           \
{                                                               \
  if ((vb##bitlen)==0) {                                        \
    if ( ( (U8*)(vb##cur) ) >= ( (U8*) (endp) ) ) dowhat        \
    (vb##bits)=radloadu32ptrBE(vb##cur);                        \
    (vb##cur)=((char*)(vb##cur))+BITSTYPEBYTES;                 \
    (vb##bitlen)=(BITSTYPELEN);                                 \
  }                                                             \
  --(vb##bitlen);                                               \
...
#define VarBitsLocalGet1WithCheckLE(v,vb,endp,dowhat)           \
{                                                               \
  if ((vb##bitlen)==0) {                                        \
    if ( ( (U8*)(vb##cur) ) >= ( (U8*) (endp) ) ) dowhat        \
    (vb##bits)=radloadu32ptr(vb##cur);                          \
    (vb##cur)=((char*)(vb##cur))+BITSTYPEBYTES;                 \
    (vb##bitlen)=(BITSTYPELEN);                                 \
  }                                                             \
  --(vb##bitlen);                                               \
