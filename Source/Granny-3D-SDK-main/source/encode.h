...
// dmm: should this be inverted?
#if (defined(__RADNGC__) || defined(__RADXBOX__) || defined(__RADPS2__) || defined(__RAD3DS__) ||   \
     defined(__RADPSP__) || defined(__RADPSP2__) || defined(__RADPS3__) || defined(__RADLINUX__) || \
     defined(__RADWII__) || defined(__RADXENON__) || defined(GENERIC_ARM9) || \
     defined(__RADIPHONE__) || defined(__RADWIIU__) || defined(__RADANDROID__))
