...
// ========================================================================
// $File: //jeffr/granny_29/rt/granny_pixel_layout.h $
...
EXPAPI GS_PARAM void ARGB8888SwizzleWii(uint32 Width, uint32 Height,
                                        uint32 SourceStride,
                                        void *SourceBits, void *DestBits);
EXPAPI GS_PARAM void All16SwizzleWii(uint32 Width, uint32 Height,
                                     uint32 SourceStride,
                                     void *SourceBits, void *DestBits);

EXPAPI GS_PARAM int32x S3TCMipSizeWii(uint32 MipWidth, uint32 MipHeight);
EXPAPI GS_PARAM bool   S3TCSwizzleWii(uint32 Width, uint32 Height,
                                      void *SourceBits,
                                      void *DestBits);
