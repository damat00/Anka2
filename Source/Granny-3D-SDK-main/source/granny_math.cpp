// ========================================================================
// $File: //jeffr/granny_29/rt/granny_math.cpp $
...
void GRANNY
ConstructQuaternion4(real32*       Quaternion,
                     real32 const* Axis,
                     real32        Angle)
{
...
InPlaceSimilarityTransform(real32 const *Affine3,
                           ...
                           real32 *ScaleShear3x3)
{
    InPlaceSimilarityTransformPosition(Affine3, Linear3x3, Position3);
    InPlaceSimilarityTransformOrientation(Linear3x3, InverseLinear3x3, Orientation4);
    InPlaceSimilarityTransformScaleShear(Linear3x3, InverseLinear3x3, ScaleShear3x3);
}
