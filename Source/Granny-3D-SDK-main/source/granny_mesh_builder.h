...
// ========================================================================
// $File: //jeffr/granny_29/rt/granny_mesh_builder.h $
...
EXPAPI GS_PARAM void DisableTangentVertexSplits(mesh_builder& Builder);
EXPAPI GS_PARAM void PreserveEmptyMaterialGroups(mesh_builder& Builder);
...
EXPAPI GS_PARAM void SetPosition(mesh_builder &Builder, real32 Px, real32 Py, real32 Pz);
...
EXPAPI GS_PARAM void   SetVertexIndex(mesh_builder &Builder, int32x Edge, int32x Index);

EXPAPI GS_PARAM void   SetPolygonForVertex(mesh_builder &Builder, int32x Polygon);
EXPAPI GS_PARAM void   SetPolygonIndexForVertex(mesh_builder &Builder, int32x Edge, int32x Index);

EXPAPI GS_PARAM void   SetNormal(mesh_builder &Builder, int32x Edge, real32 Nx, real32 Ny, real32 Nz);
EXPAPI GS_PARAM void   SetTangent(mesh_builder &Builder, int32x Edge, real32 Tx, real32 Ty, real32 Tz);
EXPAPI GS_PARAM void   SetBinormal(mesh_builder &Builder, int32x Edge, real32 Bx, real32 By, real32 Bz);
EXPAPI GS_PARAM void   SetTangentBinormalCross(mesh_builder &Builder, int32x Edge, real32 TBCx, real32 TBCy, real32 TBCz);
...
void GetFromPolygonAndIndexForVertex(mesh_builder &Builder,
                                     int32x VertexIndex,
                                     int32x& Polygon,
                                     int32x& Side);
