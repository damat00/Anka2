...
/* GCC won't let us deal properly with the summed_counts variable size array, even with */
/* casting.  Disable the diagnostic. */
#if (__GNUC__ == 4)
...
RADDEFFUNC UINTa Arith_decompress( ARITH a, ARITHBITS* ab )
{
  U32 offset;
  S32 index;
