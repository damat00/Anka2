// ========================================================================
// $File: //jeffr/granny_29/rt/granny_member_iterator.cpp $
                      ...
                      member_iterator &Result)
{
    ...
    switch(MemberIterator.IteratorType)
    {
        case MemberIteratorType:
        {
            ...
            {
                int32x Width = GetMemberArrayWidth(*MemberIterator.AtType);
                if (Width == 1)
                {
                    IterateOverMembers(*MemberIterator.PointerType, MemberIterator.At, Result);
                }
                else
                {
                    IterateOverArray(ArrayIteratorType,
                                     *MemberIterator.PointerType, Width, MemberIterator.At,
                                     Result);
                }
            }
            else
