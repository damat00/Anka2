...
// ========================================================================
// $File: //jeffr/granny_29/rt/granny_compression_tools.h $
// $DateTime: 2012/04/04 11:04:08 $
// $Change: 36933 $
// $Revision: #2 $
//
...
//   and the new symbol.
RADDEFFUNC RAD_UINTa Arith_decompress( ARITH a, ARITHBITS* ab );
...
RADDEFFUNC F64_OR_32 Arith_estimated_compressed_size( ARITH a, U32 value, U32 scale );
...
//   was an escape.
#define Arith_was_escaped( val ) ( ( ( RAD_UINTa ) ( val ) ) > 65536 )
