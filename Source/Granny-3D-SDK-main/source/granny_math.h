...
// ========================================================================
// $File: //jeffr/granny_29/rt/granny_math.h $
...
inline int32x ClampInt32(int32x Min, int32x Value, int32x Max);
...
EXPAPI void ConstructQuaternion4(real32*       Quaternion,
                                 real32 const* Axis,
                                 real32        Angle);
...
inline real32 InnerProductUnitClamped3(real32 const *V0, real32 const *V1);
...
EXPAPI GS_SAFE bool MatrixInvert3x3(real32 *Dest3x3, real32 const *Source3x3);
EXPAPI GS_SAFE bool MatrixInvert4x3(real32 *Dest4x4, real32 const *Source4x4);
...
// this include to granny_math.cpp instead.
   ...
   #define PLATFORM_HAS_FAST_MATH_INLINES 1

#elif PLATFORM_WII
   #if !defined(GRANNY_MATH_INLINES_WII_H)
   #include "granny_math_inlines_wii.h"
   #endif
