...
// ========================================================================
// $File: //jeffr/granny_29/rt/granny_model_instance.h $
...
struct model_instance
{
    ...
    transform* MirrorTransformCache;
...
model_control_binding &GetModelBindingSentinel(model_instance const &ModelInstance);
...
void GetUnnormalizedRootMotionVectors(model_instance const &ModelInstance,
...
void CreateMirrorTransformCache(model_instance& Instance);
...
EXPAPI GS_READ void GetRootMotionVectors(model_instance const &ModelInstance,
                                         ...
                                         bool Inverse);
void ClipRootMotionVectors(real32 const *Translation3,
