// ========================================================================
// $File: //jeffr/granny_29/rt/granny_bspline_buffers.cpp $
                        ...
                        real32 const *IdentityVector)
{
    ...
    int32x const KnotWindow = Degree ? 2*Degree : 1;
    ...
    if(OverOrUnderFlow)
    {
        ...
        int32x NumCurveKnots = KnotWindow;
        ...
        Assert ( FirstLocalIndex + NumCurveKnots <= KnotWindow );
        if ( NumCurveKnots > 0 )
        {
    ...
    else
    {
        ...
        else
        {
            ...
            tiPtr = ti + Degree;
            piPtr = pi + (Degree * Dimension);
            CurveExtractKnotValues ( Curve, BaseKnotIndex, KnotWindow, ti, pi, IdentityVector );
        }
    }
...
EvaluateCurveAtKnotIndex(int32x Dimension, bool Normalize,
                         ...
                         real32 const *IdentityVector)
{
    CheckCondition(!CurveIsKeyframed(Curve), return);
