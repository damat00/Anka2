// ========================================================================
// $File: //jeffr/granny_29/rt/granny_bink.cpp $
...
static bool
ShouldBink(int32x &Width, int32x &Height, int BinkVersion)
{
    if ((Width * Height) > 256)
    {
        ...
        switch (BinkVersion)
        {
            ...
            default: InvalidCodePath("Invalid bink tc version"); break;
        }
                    ...
                    uint32x Flags, int32x Compression, void *Dest)
{
    ...
    if (ShouldBink(Width, Height, 1))
    {
        ...
        int32x TempSize = ToBinkTCTempMem1(Width, Height);
        void *Temp = AllocateSize(TempSize, AllocationTemporary);
        ...
        {for(int32x PlaneIndex = 0;
             ...
             ++PlaneIndex)
        {
            Planes[PlaneIndex] = AllocateArray(Width*Height, int16, AllocationTemporary);
        }}
                      ...
                      int32x DestStride, void *Dest)
{
    ...
    if (ShouldBink(Width, Height, BinkVersion))
    {
        ...
        void *TempPixels = AllocateSize(Width*Height*4, AllocationTemporary);
