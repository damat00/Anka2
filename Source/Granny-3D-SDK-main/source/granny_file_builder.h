...
// ========================================================================
// $File: //jeffr/granny_29/rt/granny_file_builder.h $
...
struct file_builder
{
    ...
    bool32 ExcludeTypeTreeOnConversion;
    ...
    uint32       TemporaryFileNameUniq;
    file_writer* UniqLock;

    bool32 TempFilesOnDisk;
...
// Must be pow2 >= 4
EXPAPI GS_PARAM void SetFileDiskAlignment(file_builder& Builder, int32x Alignment);
