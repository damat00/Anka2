...
// ========================================================================
// $File: //jeffr/granny_29/rt/granny_compress_curve.h $
...
EXPTYPE_EPHEMERAL struct compress_curve_parameters
{
    ...
    bool32 AllowDegreeReduction;            // Allow the solver to attempt to do constant/identity instead
    bool32 AllowReductionOnMissedTolerance; // Allows the solver to aggressively reduce curve size on tolerance failure
