...
class Battlepass(ui.ScriptWindow):
	def __init__(self):
		...
		self.Type_Images = [0,
		"premium_new_battlepas/quest_icon/kill_id_any.png",#1
		"premium_new_battlepas/quest_icon/kill_id_any.png",#2
		"premium_new_battlepas/quest_icon/kill_id_any.png",#3
		"premium_new_battlepas/quest_icon/kill_boss_uni.png",#4
		"premium_new_battlepas/quest_icon/kill_stone_any.png",#5
		"premium_new_battlepas/quest_icon/use_refine_id_uni.png",#6
		"premium_new_battlepas/quest_icon/hatch_id_uni.png",#7
		"premium_new_battlepas/quest_icon/shout.png",#8
		"premium_new_battlepas/quest_icon/kill_boss_uni.png",#9
		"premium_new_battlepas/quest_icon/kill_boss_uni.png",#10
		"premium_new_battlepas/quest_icon/kill_boss_uni.png",#11
		"premium_new_battlepas/quest_icon/kill_boss_uni.png",#12
		"premium_new_battlepas/quest_icon/kill_boss_uni.png",#13
		"premium_new_battlepas/quest_icon/kill_boss_uni.png",#14
		"premium_new_battlepas/quest_icon/kill_boss_uni.png",#15
		"premium_new_battlepas/quest_icon/kill_boss_uni.png",#16
		"premium_new_battlepas/quest_icon/kill_boss_uni.png",#17
		"premium_new_battlepas/quest_icon/kill_boss_uni.png",#18
		"premium_new_battlepas/quest_icon/kill_boss_uni.png",#19
		"premium_new_battlepas/quest_icon/kill_boss_uni.png",#20
		"premium_new_battlepas/quest_icon/kill_boss_uni.png",#21
		"premium_new_battlepas/quest_icon/kill_boss_any.png",#22
		"premium_new_battlepas/quest_icon/kill_boss_any.png",#23
		"premium_new_battlepas/quest_icon/kill_boss_any.png",#24
		"premium_new_battlepas/quest_icon/kill_boss_any.png",#25
		"premium_new_battlepas/quest_icon/kill_boss_any.png",#26
		"premium_new_battlepas/quest_icon/kill_boss_any.png",#27
		"premium_new_battlepas/quest_icon/kill_boss_any.png",#28
		"premium_new_battlepas/quest_icon/kill_boss_any.png",#29
		"premium_new_battlepas/quest_icon/kill_boss_any.png",#30
		"premium_new_battlepas/quest_icon/kill_boss_any.png",#31
		"premium_new_battlepas/quest_icon/kill_boss_any.png",#32
		"premium_new_battlepas/quest_icon/kill_boss_any.png",#33
		"premium_new_battlepas/quest_icon/kill_boss_any.png",#34
		"premium_new_battlepas/quest_icon/kill_boss_any.png",#35
		"premium_new_battlepas/quest_icon/kill_boss_any.png",#36
		]
	...
	def Show(self):
		self.LoadWindow()
		self.ScrollBar.SetMiddleBarSize(float(2) / float(constInfo.size_battle_pass_premium))
		self.final_reward.SetItemSlot(0, constInfo.final_rewards_premium[0], constInfo.final_rewards_premium[3])
		self.final_reward.SetItemSlot(1, constInfo.final_rewards_premium[1], constInfo.final_rewards_premium[4])
		self.final_reward.SetItemSlot(2, constInfo.final_rewards_premium[2], constInfo.final_rewards_premium[5])
		for i in range(9):
			self.MakeButton(
				i,\
				self.board,\
	...
	def LoadWindow(self):
		try:
			...
			PythonScriptLoader.LoadScriptFile(self, "UIScript/battlepasspremium.py")
		except:
			import exception
		...
		self.f_button.SetEvent(lambda : net.SendChatPacket("/final_reward_battlepass_premium"))
	...
	def OnUpdate(self):
		...
		self.gauge_f.SetPercentage(self.GetFinishedMission(), constInfo.size_battle_pass_premium)
		for i in range(len(self.text)):
			self.gauge[i].SetPercentage(self.Get2(i, "iCounts"), self.Get(i, "iCount"))
			if self.Get2(i, "iStatus") > 0:
				self.list_bg[i].LoadImage("premium_new_battlepas/big_finished.png")
				self.list_bg[i].Show()
		for i in range(len(self.tab)):
			if self.tab[i].IsDown():
				self.select = i
				MissionName = str(constInfo.info_missions_bp_premium[int(i)]["Name"]).replace("Oldur", "Oldur")
	...
	def OnScroll(self):
		board_count = 9
		pos = int(self.ScrollBar.GetPos() * max(0, int(constInfo.size_battle_pass_premium) - board_count))
	...
	def GetFinishedMission(self):
		finished = 0
		for i in range(constInfo.size_battle_pass_premium):
			if int(constInfo.info_missions_bp_premium[int(i)]["iStatus"]) > 0:
				finished = finished + 1
		return finished
	...
	def Get(self,index, var2):
		try:
			return int(constInfo.missions_bp_premium[int(index)][var2])
		except (KeyError, IndexError):
			return 0

	def Get2(self,index, var2):
		try:
			return int(constInfo.info_missions_bp_premium[int(index)][var2])
		except (KeyError, IndexError):
			return 0

	def Get3(self,index, var2):
		try:
			return int(constInfo.rewards_bp_premium[int(index)][var2])
		except (KeyError, IndexError):
			return 0

	def Get4(self, index, var2):
		try:
			return int(constInfo.rewards_bonus_bp_premium[int(index)][var2])
		except (KeyError, IndexError):
			return 0

	def MakeButton(self, index, parent, x, y):
		size_bp = int(constInfo.size_battle_pass_premium)
		if not size_bp or index >= size_bp:
			return

		self.tab[index] = ui.MakeButton(parent, x, y+10-3, False, "premium_new_battlepas/", "mission_btn_0.png", "mission_btn_1.png", "mission_btn_2.png")
		...
		MissionName2 = str(constInfo.info_missions_bp_premium[int(index)]["Name"]).replace("Oldur", "Oldur")
		self.text[index].SetText(str(MissionName2))
		self.text[index].Show()

		self.list_bg[index] = ui.MakeImageBox(self.tab[index], "premium_new_battlepas/big_finished.png", 49, 30)
		...
		self.bitirici[index] = ui.MakeButton(self.tab[index], 273, 13, False, "", "premium_new_battlepas/bonus.png", "premium_new_battlepas/bonus.png", "premium_new_battlepas/bonus.png")
		...
		self.odul[index] = ui.MakeButton(self.tab[index], 308, 13, False, "", "premium_new_battlepas/odul.png", "premium_new_battlepas/odul.png", "premium_new_battlepas/odul.png")
		...
		self.odulbackground.LoadImage("premium_new_battlepas/yeni_gorev.png")
	...
	def ConfirmBitirici(self,index):
		net.SendChatPacket("/battlepass_bitirici_premium %d" % int(index))
	...
	def OverInItemFinal(self, slotindex):
		if 0 != self.tooltipItem:
			self.tooltipItem.SetItemToolTip(constInfo.final_rewards_premium[slotindex])
