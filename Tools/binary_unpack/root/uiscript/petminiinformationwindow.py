...
##LifeTime Gauge
if app.ENABLE_UPBRINGING_PET_CONQUEROR_LEVEL:
	LIFE_TIME_SCALE_X	= 0.35
else:
	LIFE_TIME_SCALE_X	= 0.30
LIFE_TIME_SCALE_Y	= 0.4
	...
	window = {
		...
		(
			...
			## Skill Slot 2
			{
				...
				"slot" : ({"index":0, "x":54, "y":25, "width":16, "height":16,},),
			},
			## Skill Slot 3
			{
				...
				"slot" : ({"index":0, "x":72, "y":25, "width":16, "height":16,},),
			},
			## Potential Skill Slot 1
			{
				"name" : "mini_potential_skill_slot_0",
				"type" : "slot",
				"style" : ("attach",),
				...
				"slot" : ({"index":0, "x":90, "y":25, "width":16, "height":16,},),
			},
			## Potential Skill Slot 2
			{
				"name" : "mini_potential_skill_slot_1",
				"type" : "slot",
				"style" : ("attach",),
				...
				"slot" : ({"index":0, "x":108, "y":25, "width":16, "height":16,},),
			},
